...
$jsonBancoR = json_decode($dadosrr['jsonrespostas']);
...
if ($tiporefaux == 'produto') {
    while ($dadosReferencia = mysqli_fetch_array($resultreferencia)) {
        ...
        $body = $dadosReferencia['produto'] . '**' . $dadosReferencia['peso'] . ' - ' . $dadosReferencia['tipopeso'] . '**' . $dadosReferencia['categoria'];
    ...
    while ($dadosReferencia = mysqli_fetch_array($resultreferencia)) {
        ...
        $body = $dadosReferencia['nomefantasia'] . '**' . $dadosReferencia['base'] . '**' . $dadosReferencia['cidade'];
        foreach ($jsonBancoR as $resposta) {
            $respostapergunta = $resposta->respostapergunta;
            $tiporesposta = $resposta->tiporesposta;
            $ordemresposta  = $resposta->ordem;
