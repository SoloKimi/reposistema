      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold">Franklyn Pereira</span></h1>
            <h3 class="welcome-sub-text">Veja abaixo a performace da semana </h3>
          </li>
        </ul>
