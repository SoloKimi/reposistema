...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h2 class="title" id="defaultModalLabel">Referencias ao Relatório - <?= $dados['titulo']; ?></h2>
        </div>
                        ...
                        <table class="table">
                            <thead>
                                <?php if ($tiporefaux == 'produto') { ?>
                                    <tr>
                                        <th style="width: 20%;text-align: center">Produto</th>
                                        <th style="width: 10%;text-align: center">Categoria</th>
                                        <th style="width: 15%;text-align: center">Familia 1</th>
                                        <th style="width: 15%;text-align: center">Familia 2</th>
                                        <th style="width: 15%;text-align: center">Embalagem</th>
                                        <th style="width: 25%;text-align: center">Descrição</th>
                                    </tr>
                                <?php } else { ?>
                                    <tr>
                                        <th style="width: 20%;text-align: center">Revenda</th>
                                        <th style="width: 10%;text-align: center">CNPJ</th>
                                        <th style="width: 15%;text-align: center">Base</th>
                                        <th style="width: 15%;text-align: center">Adesão</th>
                            ...
                            <tbody>
                                ...
                                if ($tiporefaux == 'produto') {
                                    while ($dadosReferencia = mysqli_fetch_array($resultreferencia)) { ?>
                                        <tr>
                                            <th style="text-align: center"><?= $dadosReferencia['produto']; ?></th>
                                            <th style="text-align: center"><?= $dadosReferencia['categoria']; ?></th>
                                            <th style="text-align: center"><?= $dadosReferencia['familia1']; ?></th>
                                            <th style="text-align: center"><?= $dadosReferencia['familia2']; ?></th>
                                            <th style="text-align: center"><?= $dadosReferencia['embalagem']; ?></th>
                                            <th style="text-align: center"><?= $dadosReferencia['descricao']; ?></th>
                                        </tr>
                                    <?php }
                                } else {
                                    while ($dadosReferencia = mysqli_fetch_array($resultreferencia)) {
                                        $adesao = $dadosReferencia['adesao'];
                                        if ($adesao == '') {
                                            $adesao = '-';
                                        }
                                    ?>
                                        <tr>
                                            <th style="text-align: center"><?= $dadosReferencia['nomefantasia']; ?></th>
                                            <th style="text-align: center"><?= $dadosReferencia['cnpj']; ?></th>
                                            <th style="text-align: center"><?= $dadosReferencia['base']; ?></th>
                                            <th style="text-align: center"><?= $adesao; ?></th>
                                            <th style="text-align: center"><?= $dadosReferencia['cidade']; ?></th>
                                        </tr>
                                <?php }
                                } ?>
                            </tbody>
